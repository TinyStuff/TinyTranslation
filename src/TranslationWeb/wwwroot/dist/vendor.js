var vendor_10dee78e3be1ee06b73e =
...
function lifecycleMixin (Vue) {
  Vue.prototype._update = function (vnode, hydrating) {
    ...
    // based on the rendering TranslationWeb used.
    if (!prevVnode) {
      // initial render
      vm.$el = vm.__patch__(
...
function createPatchFunction (TranslationWeb) {
  var i, j;
  var cbs = {};

  var modules = TranslationWeb.modules;
  var nodeOps = TranslationWeb.nodeOps;
